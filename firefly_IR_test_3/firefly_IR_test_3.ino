...
int LED2 = 1;
int LED3 = 0;
int delay1 = 5;              //delay value (ms)
int loop1;              //loop value 1
int loop2;            //loop value 2
int control = 0;        //Control state
int ledPin;
int randNumber;
int jcount;                //firefly pattern internal counter
void setup() {
...
//      if (inputVal > 0)  break;            //Check for Button Press
    ...
    jcount = 0;
      ...
      while (jcount < loop1) {                    //Pulse LED up
      
 //         if (inputVal > 0)  break;        //Check for Button Press
      
          for (int n = 1; n + jcount > 0; n--){
...
//              if (inputVal > 0)  break;    //Check for Button Press
    ...
    jcount = 0;
      ...
      while (jcount < loop1) {                      //Fade LED down
     
//          if (inputVal > 0)  break;          //Check for Button Press 
     
          for (int n = 1; n + jcount > 0; n -= 1){
...
//              if (inputVal > 0)  break;      //Check for Button Press
          ...
          for (int m = 0; m + jcount < loop2; m += 1){
 ...
 //             if (inputVal > 0)  break;      //Check for Button Press
  ...
  if (delay1 >= 25) control = 1;
  if (delay1 <= 5) control =0;
  }
  return;
